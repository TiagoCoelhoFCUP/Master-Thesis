...
df_new = df[['created_at','polarity','topic','topic_perc','user.name','user.followers_count','retweet_count','favorite_count']]
...
temp2 = df_new.set_index('created_at').groupby([pd.Grouper(freq='D'),'user.name'])['topic_perc','favorite_count','retweet_count','polarity'].mean().reset_index()
...
temp.columns=['day1_0','day1_1','day1_2','day1_3','day1_4','day1_5']
df = pd.concat([df,temp], axis=1)

temp = pd.get_dummies(df.Day2)
temp.columns=['day2_0','day2_1','day2_2','day2_3','day2_4','day2_5']
df = pd.concat([df,temp], axis=1)

temp = pd.get_dummies(df.Day3)
temp.columns=['day3_0','day3_1','day3_2','day3_3','day3_4','day3_5']
df = pd.concat([df,temp], axis=1)

temp = pd.get_dummies(df.Day4)
temp.columns=['day4_0','day4_1','day4_2','day4_3','day4_4','day4_5']
df = pd.concat([df,temp], axis=1)

temp = pd.get_dummies(df.Day5)
temp.columns=['day5_0','day5_1','day5_2','day5_3','day5_4','day5_5']
df = pd.concat([df,temp], axis=1)

temp = pd.get_dummies(df.Day6)
temp.columns=['day6_0','day6_1','day6_2','day6_3','day6_4','day6_5']
df = pd.concat([df,temp], axis=1)

temp = pd.get_dummies(df.Day7)
temp.columns=['day7_0','day7_1','day7_2','day7_3','day7_4','day7_5']
df = pd.concat([df,temp], axis=1)
...
x = df[['Avg Retweets','Avg Favorites',"Caltech", "Cambridge University", "ETH Zurich", "Harvard University","Imperial College", "Johns Hopkins University", "MIT", "Stanford University","The University of Chicago","UCL", "University of Oxford","UC Berkeley","day1_0",	"day1_1",	"day1_2",	"day1_3",	"day1_4",	"day1_5",	"day2_0",	"day2_1",	"day2_2",	"day2_3",	"day2_4",	"day2_5",	"day3_0",	"day3_1",	"day3_2", "day3_3", "day3_4", "day3_5", "day4_1","day4_2","day4_3","day4_4", "day4_5","day5_0",	"day5_1",	"day5_2",	"day5_3",	"day5_4",	"day5_5","day6_0",	"day6_1",	"day6_2",	"day6_3",	"day6_4",	"day6_5", "day7_0",	"day7_1",	"day7_2",	"day7_3",	"day7_4",	"day7_5",	"monday",	"tuesday",	"wednesday",	"thursday",	"friday",	"saturday",	"sunday",	"january"	,"february"	,"march",	"april",	"may",	"july",	"june",	"august",	"september",	"october",	"november",	"december",	"2019",	"2020"]] #independent columns
...
featureScores.drop(featureScores.loc[featureScores['Score'] < 0.011].index, inplace=True)
...
x = df[["day3_3","day6_1","day5_3","september","Imperial College","UC Berkeley","day1_2","saturday","day5_0","day6_3","day7_3","Avg Retweets","Caltech","march","day7_1","day3_0","day7_2","day1_1","UCL","day7_0"]].to_numpy()
...
logistic = LogisticRegression(class_weight='balanced',fit_intercept=True,max_iter=50,multi_class='auto',solver='liblinear')

"""Decision Tree"""
from sklearn.tree import DecisionTreeClassifier
dt = DecisionTreeClassifier(ccp_alpha=0.0, criterion='gini',max_depth=61,max_features='sqrt', min_impurity_decrease=0.0, min_samples_leaf=10, min_samples_split=14, splitter='random')

"""DT Bagging"""
from sklearn.ensemble import BaggingClassifier
bagging = BaggingClassifier(bootstrap=False, bootstrap_features=False, max_features=9, max_samples=212, n_estimators=69)

"""DT Boosting"""
from sklearn.ensemble import AdaBoostClassifier
boosting = AdaBoostClassifier(algorithm='SAMME.R', learning_rate=0.6326530612244897, n_estimators=15)

"""Random Forest"""
from sklearn.ensemble import RandomForestClassifier
rf = RandomForestClassifier(ccp_alpha=0.0, max_depth=30, max_features='auto', min_impurity_decrease=0.0, min_samples_leaf=8, min_samples_split=50, n_estimators=62)

"""KNN"""
from sklearn.neighbors import KNeighborsClassifier
knn = KNeighborsClassifier(algorithm='brute', leaf_size=1, metric='manhattan', n_neighbors=69, weights='uniform')

"""SVM"""
from sklearn.svm import SVC
svm = SVC(decision_function_shape='ovo', degree=1, gamma='auto', kernel='rbf', probability=True, shrinking=True, cache_size=7000)

"""MLP"""
from sklearn.neural_network import MLPClassifier
mlp = MLPClassifier(activation='identity', early_stopping=True, hidden_layer_sizes=(100, 50), learning_rate='invscaling')
